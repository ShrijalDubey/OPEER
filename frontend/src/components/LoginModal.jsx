    ...
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.header}>
          <h2 className={styles.title}>Welcome to OPEER</h2>
          <p className={styles.subtitle}>Sign in to join your campus thread.</p>
        </div>
        ...
        <div className={styles.footer}>
          By clicking continue, you agree to our <span className={styles.link}>Terms of Service</span> and <span className={styles.link}>Privacy Policy</span>.
        </div>
      </div>
    </div>
  );
