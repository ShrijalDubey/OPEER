...
const Navbar = () => {
  ...
  const navItems = [
    { label: "Getting started", link: "#features" }, 
    { label: "Join a Thread", link: "#join-thread" },
    { label: "Join a Project", link: "#join-project" },
    { label: "Upload Project", link: "#upload" },
    { label: "Contribute", link: "https://github.com/ShrijalDubey/OPEER" },
